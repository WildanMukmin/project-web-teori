                ...
                <?php foreach ($books as $book): ?>
                    <tr class="text-center hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 border space-x-1">
                            ...
                            <a href="../peminjaman/add.php?id_buku=<?= $book['id']; ?>" class="bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded text-sm">Pinjam</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="4" class="text-center py-4 text-gray-500">Belum ada data buku.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
