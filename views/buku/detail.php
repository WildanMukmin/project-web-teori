...
<div class="max-w-6xl mx-auto mt-12 px-4 md:px-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white shadow-xl rounded-2xl p-6">
        ...
        <div class="flex justify-center items-start">
            <img src ="https://down-id.img.susercontent.com/file/id-11134207-7r98y-loxya608e6j12e" alt="Cover Buku"
            <img src="https://bukukita.com/babacms/displaybuku/95219_f.jpg" alt="Cover Buku"
